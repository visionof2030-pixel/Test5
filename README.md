...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    /* ============================================================
       جدول التوقعات المدمج - الأسماء في اليمين واللون أصفر غامق
       ============================================================ */
    ...
    /* اسم المستخدم - في أقصى اليمين ولون أصفر غامق */
    .predictions-table .user-name {
      font-weight: 800;
      color: #f0b429 !important;
      /* أصفر غامق */
      text-shadow: 0 0 20px rgba(240, 180, 41, 0.15);
    }
  ...
  function renderMatchCard(m, isUpcoming) {
    ...
    if (isLive) { 
      ...
      if (previousMatch) {
        ...
        homeScore = isReversed ? previousMatch.awayScore : previousMatch.homeScore;
        awayScore = isReversed ? previousMatch.homeScore : previousMatch.awayScore;
