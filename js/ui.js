...
import {
    ...
    getSubmittedMatches,
    addSubmittedMatch,
    removeSubmittedMatch,
    isMatchSubmitted,
    translateToArabic,
    translateBracketTeamName,
    getStadiumName,
    getSortTimestamp,
    parseScorersWithMinutes,
    upcomingMatches
} from './utils.js';
...
import {
    openNameModal as openNameModalPred,
    openPredictionModal as openPredictionModalPred,
    openEditPredictionModal as openEditPredictionModalPred,
    openMatchPredictions as openMatchPredictionsPred,
    openPlayerPredictions as openPlayerPredictionsPred,
    openViewPredictionsModal as openViewPredictionsModalPred,
    loadUserPredictions,
    getAllPredictions,
    getPredictionsForMatchFull,
    getPredictionStatus,
    savePrediction,
    getUserPrediction
} from './predictions.js';
...
import {
    ...
    renderCompare,
    getAllPlayersStats,
    openCompareModal as openCompareModalLeader,
    closeCompareModal as closeCompareModalLeader
} from './leaderboard.js';
...
// ============================================================
//  عرض المباريات السابقة مع فلتر
// ============================================================
export function renderPreviousGamesFiltered() {
...
// ============================================================
//  عرض شجرة البطولة (المحسّنة)
// ============================================================
export function renderBracket() {
    const container = document.getElementById('bracketContainer');

    // جمع المباريات من المصادر
    let allMatches = [];
...
//  عرض جميع التوقعات
// ============================================================
export async function renderAllPredictions() {
...
// ============================================================
//  دوال تفاصيل المباريات في المخطط
// ============================================================
export async function openBracketMatchDetail(matchId) {
...
// ============================================================
//  دوال المباريات السابقة
// ============================================================
export function openPreviousMatchPredictions(team1, team2, homeScore, awayScore) {
...
// ============================================================
export function updateShareAllCount() {
    if (!isAuthorized) {
...
// ============================================================
//  دوال التحقق من الرابط
// ============================================================
export function checkUrlForMatch() {
...
export function closeViewPredictionsModal() {
    document.getElementById('viewPredictionsModal').classList.remove('active');
    document.body.style.overflow = '';
}

export function closePlayerPredictionsModal() {
    document.getElementById('playerPredictionsModal').classList.remove('active');
    document.body.style.overflow = '';
}

export function closeMatchPredictionsModal() {
    document.getElementById('matchPredictionsModal').classList.remove('active');
    document.body.style.overflow = '';
}

// ============================================================
//  دوال النوافذ الرئيسية للتوقعات (وصلات إلى predictions.js)
// ============================================================
export function openNameModal(matchId, team1, team2, timeISO) {
    openNameModalPred(matchId, team1, team2, timeISO);
}

export function openPredictionModal(matchId, team1, team2, timeISO, userName) {
    openPredictionModalPred(matchId, team1, team2, timeISO, userName);
}

export function openEditPredictionModal(matchId, team1, team2, timeISO) {
    openEditPredictionModalPred(matchId, team1, team2, timeISO);
}

export function openMatchPredictions(matchId, team1, team2, homeScore, awayScore) {
    openMatchPredictionsPred(matchId, team1, team2, homeScore, awayScore);
}

export function openPlayerPredictions(userName) {
    openPlayerPredictionsPred(userName);
}

export function openViewPredictionsModal(matchId, team1, team2) {
    openViewPredictionsModalPred(matchId, team1, team2);
}

// ============================================================
//  دوال المقارنة (وصلات إلى leaderboard.js)
// ============================================================
export function openCompareModal(selectedPlayer) {
    openCompareModalLeader(selectedPlayer);
}

export function closeCompareModal() {
    closeCompareModalLeader();
}

// ============================================================
//  دوال التحميل (وصلات إلى app.js)
// ============================================================
export function loadPreviousGames() {
    // سيتم استدعاؤها من app.js
    console.warn("loadPreviousGames should be imported from app.js");
}

export function closeNameModal() {
    // سيتم استدعاؤها من predictions.js
    console.warn("closeNameModal should be imported from predictions.js");
}